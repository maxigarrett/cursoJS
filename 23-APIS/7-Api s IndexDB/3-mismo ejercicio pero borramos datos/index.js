...
if(indexDB && form)
{
    ...
    const updateData=(data)=>{
        ...
        requestt.onsuccess=()=>
        {
            form.button.dataset.action='add';//para q una ves actualizado los datos vuelva al data-set="add"
            readData();
        }
    ...
    const deleteData=(key)=>
    {
        ...
        // el put si el dato existe lo actualiza si no existe lo añade
        const requestt=objectStore.delete(key);
        requestt.onsuccess=()=>
        {
            // form.button.dataset.action='delete';
            readData();
        }
    }
    ...
    const readData= ()=>
    {
        ...
        requestt.onsuccess=(e)=>
        {
            ...
            if(cursor)
            {
                ...
                taskDelete.dataset.key=cursor.key;//almacenamos la clave en el boton delete para poder usar ese valor para borrar
    ...
    task_tareas.addEventListener('click',(e)=>
    {
        ...
        }else if(e.target.dataset.type=='delete')//si precionamos en delete
        {
